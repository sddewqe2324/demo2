...
const Payments = () => {
    ...
    //     switch (activeTab) {
    //         case 4:
    //             setPayment(`upi://pay?pa=${products.upi}pn=ServiceStation&tn=Transfer-to-products&am=${Number(
    //                 data.selling_price
    //             )}&mode=02&cu=INR&tr`);
    //             break;
    //         case 1:
    ...
    //             break;
    //         case 3:
    //             setPayment(`paytmmp://pay?pa=${products.upi}&pn=Online%20Shopping&am=${Number(
    //                 data.selling_price
    //             )}&tr=H2MkMGf5olejI&mc=8931&cu=INR&tn=Online%20Shopping`);
    //             break;
    //         case 5:
    //             setPayment(`whatsapp://pay?pa=${products.upi}&pn=Online%20Shopping&am=${Number(
    //                 data.selling_price
    //             )}&tr=H2MkMGf5olejI&mc=8931&cu=INR&tn=Online%20Shopping`);
    //             break;
            ...
            <div className="card py-1 my-1">
                <div className="py-2 px-3">
                    ...
                    {products.Gpay &&
                        ...
                        >
                            <label className="form-check-label">
                                ...
                                {/* <img
                                src="https://festive99.shop/assets/images/gpay_icon.svg"
                                className="pay-logo"
                                alt="button"
                            /> */}
                    ...
                    >
                        <label className="form-check-label">
                            <img
                                src={"/uploads/WhatsApp-Logo.png"}
                                className="pay-logo"
                                alt="button"
                                style={{ maxWidth: 45 }}
                            />
                            <span className="unaviablee mx-4">Whatspp Pay</span>
                        </label>
                    </div>}
                </div>
            </div>
            <div className="card px-3 py-4 mb-2" id="price-detail">
                ...
                <div className="price-detail-div mt-2">
                    <div className="product-price-list my-3">
                        ...
                        <span className="data selling_price me-0 td-none">₹ {data.selling_price}</span>
                    </div>
                    <div className="product-price-list my-3">
                    ...
                    <div className="product-price-list mt-3 pt-3 total">
                        ...
                        <span className="data selling_price">₹  {data.selling_price}</span>
                    </div>
                </div>
            </div>
            ...
            <div className="button-container flex p-3 bg-white">
                {/* <div className="col-6 footer-price">
                    <span className="strike mrp ms-0 mb-1" id="mrp">
                        - ₹  {Number(data.min_catalog_price - data.min_catalog_price - Number(data.min_catalog_price * 90 / 100)) || 0}
                    </span>
                    <span className="selling_price" id="selling_price">
                        ₹ {Number(data.min_catalog_price - Number(data.min_catalog_price * 90 / 100)) || 0}
                    </span>
                </div> */}
                <div className="col-6 footer-price">
                    <span className="strike mrp ms-0 mb-1" id="mrp">
